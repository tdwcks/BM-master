...
$lang['ABOUT_TEXT'] = '<p class="large">With over 40 years combined experience, BM provides bespoke construction and refurbishment expertise for the prime residential market. Our aim is to help you Build More.</p><p class="large">We have recently and successfully completed residential developments to a very high specification in the Pyrenees and Mallorca. Please contact us to discuss your ideas.</p>';

// What We Do
$lang['WHAT_WE_DO_TITLE'] = 'What We Do';
$lang['WHAT_WE_DO_TEXT'] = '<p class="large">From new-builds and complete refurbishments to on-going maintenance, we believe that we are creating a better life for our clients and our satisfaction comes from taking our clients ideas and delivering sound results.</p><p class="large">From our extensive experience in delivering residential projects, we understand that the key to ultimate quality of the final product is flexibility, communication and professionalism. A collaborative approach with all parties helps to ensure the smooth and efficient progress of each project, whatever the size.</p>';

// Four Blocks
$lang['RESIDENTIAL_TEXT'] = '<h3>Residential</h3>
...
$lang['NEW_BUILD_TEXT'] = '<h3>New Build &amp; Total Conversion</h3>
...
$lang['REFURBISHMENT_TEXT'] = '<h3>Refurbishment</h3>
